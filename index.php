      ...
      "isProfessorDebug" => $isProfessorDebug,
        ...
        <div class="header-bar <?php echo $headerClass; ?>">
            ...
            <div class="actions">
                ...
                <a href="admin/professor.php" class="btn" style=" background-color: rgba(255, 255, 255, 0.2) ;border: 1px solid rgba(255, 255, 255, 0.3) ;border-radius: 0.375rem ;">
                ...
                <?php endif; ?>
                <?php if (!$isProfessorDebug): ?>
                <a href="core/logout.php" class="btn" style=" background-color: rgba(255, 255, 255, 0.2) ;border: 1px solid rgba(255, 255, 255, 0.3) ;border-radius: 0.375rem ;">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
