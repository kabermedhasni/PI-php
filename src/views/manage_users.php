    ...
    if (empty($email) || empty($password) || empty($role)) {
        ...
        try {
            ...
            if ($check_stmt->fetch()) {
                ...
                $stmt->execute([$email, $hashed_password, $role, ($role === 'student' ? $group_id : null), $email]);
        ...
        <div class="container mx-auto px-4 py-6">
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="../admin/index.php" class="bg-white/20 hover:bg-white/30 text-white font-medium py-2 px-4 rounded transition duration-300 text-sm">Retour au Tableau de Bord</a>
                </div>
            </div>
        </div>
    </header>
