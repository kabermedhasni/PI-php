    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function updatePublishStatus() {
            ...
            statusDiv.classList.remove("hidden", "status-success", "status-warning", "status-info");
            ...
            conflicts.forEach(conflict => {
                ...
                conflictHtml += `
                    <div class="conflict-item">
                        ...
                        <p><span class="strong-text">Professeur:</span> ${conflict.professor || classData.professor}</p>
                ...
                if (conflict.is_split) {
                    if (conflict.split_type === 'same_time') {
                        ...
                        <div class="conflict-subsection">
                            ...
                            <p><span class="strong-text">Sous-groupe 1:</span> ${conflict.subgroup1 || ''}</p>
                            <p><span class="strong-text">Sous-groupe 2:</span> ${conflict.subgroup2 || ''}</p>
                            <p><span class="strong-text">Professeur 2:</span> ${conflict.professor2 || ''}</p>
                            <p><span class="strong-text">Salle 2:</span> ${conflict.room2 || ''}</p>
                        </div>`;
                    } else if (conflict.split_type === 'single_group') {
                        conflictHtml += `
                        <div class="conflict-subsection">
                            <p class="conflict-title conflict-title-info">Cours avec sous-groupe unique :</p>
                            <p><span class="strong-text">Sous-groupe:</span> ${conflict.subgroup || ''}</p>
                        </div>`;
                    }
                }
        ...
        function showRoomConflict(conflicts, classData) {
            ...
            conflicts.forEach(conflict => {
                conflictHtml += `
                    <div class="conflict-item">
                        <p><span class="strong-text">Salle:</span> ${conflict.room || classData.room}</p>
                        <p><span class="strong-text">Jour:</span> ${conflict.day}</p>
                        <p><span class="strong-text">Heure:</span> ${conflict.time}</p>
                        <p><span class="strong-text">Année:</span> ${conflict.year}</p>
                        <p><span class="strong-text">Groupe:</span> ${conflict.group}</p>
                        <p><span class="strong-text">Matière:</span> ${conflict.subject}</p>
                        <p><span class="strong-text">Professeur:</span> ${conflict.professor}</p>`;
                ...
                if (conflict.is_split) {
                    if (conflict.split_type === 'same_time') {
                        ...
                        <div class="conflict-subsection">
                            ...
                            <p><span class="strong-text">Sous-groupe 1:</span> ${conflict.subgroup1 || ''}</p>
                            <p><span class="strong-text">Sous-groupe 2:</span> ${conflict.subgroup2 || ''}</p>
                            <p><span class="strong-text">Matière 2:</span> ${conflict.subject2 || ''}</p>
                            <p><span class="strong-text">Professeur 2:</span> ${conflict.professor2 || ''}</p>
                            <p><span class="strong-text">Salle 2:</span> ${conflict.room2 || ''}</p>
                        </div>`;
                    } else if (conflict.split_type === 'single_group') {
